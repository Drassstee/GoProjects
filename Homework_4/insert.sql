...
INSERT INTO public.subjects (subname) VALUES ('CSCI 151'), ('ROBT 206'),('MATH 321'),('BIOL 101'),('BUS 101');

INSERT INTO public.attendance (visit_day, visit, subject_id, student_id)
VALUES ('2026-01-12', true, 3, 11),
('2026-01-13', true, 5, 12),
('2026-01-12', false, 3, 13),
('2026-01-14', true, 1, 14),
('2026-01-16', false, 2, 11),
('2026-01-17', false, 4, 16),
('2026-01-16', true, 2, 15),
('2026-01-18', true, 3, 14);