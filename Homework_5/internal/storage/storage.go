...
func (s *StudentStorage) RegisterUser(ctx context.Context, email, password string) error {
	_, err := s.DB.Exec(ctx, "INSERT INTO users (email, password) VALUES ($1, $2)", email, password)
	return err
}
